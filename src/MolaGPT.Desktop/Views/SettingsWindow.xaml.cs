...
public partial class SettingsWindow : Window
{
    ...
    private static readonly ProviderPreset[] ProviderPresets =
    {
        new(
            ...
            DefaultModels:
            [
                new("openai/gpt-4.1-mini", "GPT-4.1 Mini", Vision: true, Tools: true),
                new("anthropic/claude-sonnet-4", "Claude Sonnet 4", Vision: true, Thinking: true, ReasoningEffort: true, Tools: true),
                new("google/gemini-2.5-flash", "Gemini 2.5 Flash", Vision: true, Thinking: true, ReasoningEffort: true, Tools: true)
            ]),
        new(
            Id: "deepseek",
            Name: "DeepSeek",
            ...
            DefaultModels:
            [
                new("deepseek-reasoner", "DeepSeek R1", Thinking: true, ReasoningEffort: true, Tools: true,
                    ThinkingParamKind: nameof(ThinkingParamKind.DeepSeekV4), DefaultEffort: "high"),
                new("deepseek-chat", "DeepSeek V3", Tools: true)
            ]),
        new(
            Id: "moonshot",
            Name: "Moonshot (Kimi)",
            ...
            DefaultModels:
            [
                new("moonshot-v1-128k", "Moonshot V1 128K", ContextWindow: 128000, Tools: true),
                new("moonshot-v1-32k", "Moonshot V1 32K", ContextWindow: 32000, Tools: true)
            ]),
        new(
            Id: "openai",
            Name: "OpenAI",
            ...
            DefaultModels:
            [
                new("gpt-4.1-mini", "GPT-4.1 mini", Vision: true, Tools: true),
                new("o4-mini", "o4-mini", Thinking: true, ReasoningEffort: true, Tools: true,
                    ThinkingParamKind: nameof(ThinkingParamKind.OpenAiReasoningEffort), DefaultEffort: "medium"),
                new("gpt-4.1", "GPT-4.1", Vision: true, Tools: true)
            ]),
        new(
            Id: "anthropic",
            ...
            DefaultModels:
            [
                new("claude-sonnet-4-6-20250514", "Claude Sonnet 4.6", Vision: true, Thinking: true, ReasoningEffort: true, Tools: true,
                    ThinkingParamKind: nameof(ThinkingParamKind.AnthropicAdaptive), DefaultEffort: "high"),
                new("claude-haiku-4-5-20241022", "Claude Haiku 4.5", Vision: true, Tools: true)
            ]),
        new(
            Id: "gemini",
            Name: "Google Gemini",
            ...
            DefaultModels:
            [
                new("gemini-2.5-flash", "Gemini 2.5 Flash", Vision: true, Thinking: true, ReasoningEffort: true, Tools: true,
                    ThinkingParamKind: nameof(ThinkingParamKind.GeminiBudget), ThinkingBudgetMin: 0, ThinkingBudgetMax: 24576, ThinkingBudgetDefault: -1),
                new("gemini-2.5-pro", "Gemini 2.5 Pro", Vision: true, Thinking: true, ReasoningEffort: true, Tools: true,
                    ThinkingParamKind: nameof(ThinkingParamKind.GeminiBudget), ThinkingBudgetMin: 128, ThinkingBudgetMax: 32768, ThinkingBudgetDefault: -1)
            ]),
        new(
            Id: "custom-openai",
            Name: "自定义（OpenAI 兼容）",
            ...
            DefaultModels:
            [
                new("gpt-4o-mini", "gpt-4o-mini", Vision: true, Tools: true)
            ])
    };
    ...
    private void ApplyPresetToForm(ProviderPreset preset)
    {
        ...
        TypePanel.Visibility = preset.Id == "custom-openai"
            ? Visibility.Visible
            : Visibility.Collapsed;
        EditorMessage.Text = $"已套用「{preset.Name}」预设，填入 API Key 后可自动获取模型。";
    }
